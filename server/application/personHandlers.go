...
func (a *Application) getPersonView(w http.ResponseWriter, r *http.Request) {
	...
	case "profile":
		...
		for _, p := range participants {
			...
			ap.ElectedTierCoverageLevelId = ch.ElectedTierCoverageLevelId
			ap.PayrollReportingState = ch.PayrollReportingState
			ap.CarrierReportingState = ch.CarrierReportingState
			ap.ElectedBenefitPlanId = ch.ElectedBenefitPlanId
			ap.ActualBenefitPlanId = ch.ActualBenefitPlanId
			ap.ElectedTierCoverageLevelId = ch.ElectedTierCoverageLevelId
			ap.ActualTierCoverageLevelId = ch.ActualTierCoverageLevelId
